...
public class BFS {
	...
	public void backtrackTransfers(ArrayList<char[]> visited, char[] curr, int nt,
							 	   int n, int m, char[] end, char[][] a, char[][] b) {
	...
	public int solve(int n, int m, char[] start, char[] end, char[][] a, char[][] b) {
		...
		ArrayList<char[]> visited = new ArrayList<>();
		backtrackTransfers(visited, start, 0, n, m, end, a, b);
